...
public class PagingBean {
	...
	/**
	 * 메인페이지 모임 리스트 보여주기 위한 생성자
	 * @param contentNumberPerPage
	 * @param totalContents
	 */
	public PagingBean(int contentNumberPerPage, int totalContents) {
		super();
		this.contentNumberPerPage = contentNumberPerPage;
		this.totalContents = totalContents;
	}

	public PagingBean(int contentNumberPerPage, int pageNumberPerPageGroup, int totalContents) {
		super();
		this.contentNumberPerPage = contentNumberPerPage;
