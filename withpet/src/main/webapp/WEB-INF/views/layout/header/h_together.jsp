...
<div class="tagline-upper text-center text-heading text-shadow text-white d-none d-lg-block"
	style="background-color: #ffffff; padding-top: 0px; border-bottom: solid 1px #cecece; background: url('resources/img/withtogether_logo.jpg'); height: 300px; margin-top:60px">
