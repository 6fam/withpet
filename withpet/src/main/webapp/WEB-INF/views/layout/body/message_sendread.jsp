...
<div class="container" style="background-color: white;  border: solid 1px #adadad; margin-top: 10px">  
	...
	<div class="row">
		...
		<div class="col-sm-10" style="border-right:height: 500px; padding-left: 20px; padding-right: 20px; padding-top: 20px">
			<a href="deleteSendMessage.do?messageNo=${readSendMessage.messageNo}" class="btn btn-success"
				style="height: 25px; width: 10%; font-size: 13px; margin-top: 8px; margin-bottom: 8px; padding-top: 3px; cursor: pointer">
				삭제</a><br>
				
			<font style="font-size: 14px"><b>받는사람</b> : ${readSendMessage.receiver}<br>
			<b>보낸시간</b> : ${readSendMessage.regdate}<br>
			</font>
			<hr>
			<font style="font-size: 14px">${readSendMessage.receivemsg }</font>
		</div>
	</div>
</div>