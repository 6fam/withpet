...
<html lang="en">
  ...
  <head>
    ...
    <script src="resources/script/jh.js"></script>
  ...
  <body style="margin-top: 0px; padding-top: 0px; background:#f7f7f7 url(resources/img/images/pattern.png) repeat top left;">
	...
	<!-- 바디 부분입니다. -->
	<div class="body"  style="background:#f7f7f7 url(resources/img/images/pattern.png) repeat top left;padding-bottom: 40px; margin-top: 80px">
