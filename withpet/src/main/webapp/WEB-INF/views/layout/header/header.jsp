...
<%-- <div class="top-bar" style="height: 40px; background-color: #353535">
	<div class="row" style="color: white">
		<div class="col-sm-3"></div>
		<div class="col-sm-5"></div>
		<div class="col-sm-4">
			<sec:authorize access="!hasRole('ROLE_ADMIN')">
				<a href="meetingwrite.do" class="btn btn-primary btn-sm"
					style="height: 25px; font-size: 12px; margin-top: 8px; margin-bottom: 4px; padding-top: 2px; cursor: pointer">모임개설</a>
				<a href="mypage.do" class="btn btn-primary btn-sm"
					style="height: 25px; font-size: 12px; margin-top: 8px; margin-bottom: 4px; padding-top: 2px; cursor: pointer">마이페이지</a>
			</sec:authorize>
			<sec:authorize access="hasRole('ROLE_ADMIN')">
				<div class="btn-group" role="group"
					...
					<div class="btn-group" role="group">
						<button id="btnGroupDrop3"
							...
							style="height: 25px; font-size: 12px; margin-top: 8px; margin-bottom: 4px; padding-top: 2px; cursor: pointer">관리자페이지</button>
						<div class="dropdown-menu" aria-labelledby="btnGroupDrop3"
							...
							<div style="border-bottom: solid 1px #cecece">
								<a class="dropdown-item" href="manager_allmember.do?pageNo=1"
									style="padding-top: 0px; padding-bottom: 5px"><font
									style="font-size: 12px">회원 관리</font></a>
							</div>
							<div style="border-bottom: solid 1px #cecece">
								<a class="dropdown-item" href="manager_allboard.do?pageNo=1"
									style="padding-top: 0px; padding-bottom: 5px"><font
									style="font-size: 12px">게시글 관리</font></a>
							</div>
							<div>
								<a class="dropdown-item" href="manager_alldonation.do?pageNo=1"
									style="padding-top: 0px; padding-bottom: 5px"><font
									style="font-size: 12px">모금함 관리</font></a>
							</div>
						</div>
					</div>
				</div>
			...
			<button type="button" class="btn btn-primary btn-sm"
				data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
				style="height: 25px; font-size: 12px; margin-top: 8px; margin-bottom: 4px; padding-top: 2px; cursor: pointer">서비스소개</button>
		</div>
	</div>
</div>

<div
	class="tagline-upper text-center text-heading text-shadow text-white d-none d-lg-block"
	style="background-color: #ffffff; padding-top: 0px">
	<a href="home.do"><img src="resources/img/logo3.png"
		style="width: 400px; margin-top: 5px; margin-bottom: 5px;"></a>
</div>
	...
	<div class="col-sm-9 	">
		<div class="row">
			<div class="col-sm-8" style="text-align: left; padding-left: 0px;">
				...
				<!-- 돌보미게시판 -->
				<a href="carer.do?pageNo=1" style="text-decoration:none ;color:black ;display:inline-block;height: 30px; font-size: 18px; margin-top: 12px; margin-bottom: 8px; padding-top: 6px; cursor: pointer">
				돌보미
				</a>
				<font style="color: #ddd">|</font>
				<a href="sharemarket.do" style="text-decoration:none ;color:black ;display:inline-block;height: 30px; font-size: 18px; margin-top: 12px; margin-bottom: 8px; padding-top: 6px; cursor: pointer">
				나눔마켓
				</a>
				<!-- 반려견기부게시판 -->
				<font style="color: #ddd">|</font> 
