...
<div class="container"
	...
	<!-- 돌보미 상세정보 탭 시작 -->
	<div class="row"
		style="margin-left: 0px; margin-top: 30px; margin-right: 0px">
		<div class="col-sm-1"></div>
		<div class="col-sm-10">
		...
		<div class="col-sm-10" style="margin: 30px">
			<div id="div1">
				...
				<div class="row" style="margin-left: 0px; margin-top: 30px">
					...
					<div class="col-sm-9"><textarea class="form-control" id="exampleTextarea" style="height:450px"placeholder="내용을 입력해주세요"></textarea> </div>
				</div>
			</div>
	...
	<div class="row" style="margin-top: 40px; margin-bottom: 40px">
		...
		<div class="col-sm-2">
			<a href="care_update.do" class="btn btn-outline-danger"
				style="width: 100px; height: 30px; font-size: 12px; margin-top: 8px; margin-bottom: 8px; padding-top: 8px; cursor: pointer">수정완료</a>
		</div>
		<div class="col-sm-1"></div>
		<div class="col-sm-2">
