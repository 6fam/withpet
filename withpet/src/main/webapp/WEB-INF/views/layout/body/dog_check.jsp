...
<div class="container" style="background-color: white;  border: solid 1px #adadad; margin-top: 10px;padding-bottom:60px;">  
 ...
 <form action="${pageContext.request.contextPath }/insertDogInfo.do" method="post" id="dogSubmit" enctype="multipart/form-data"
  onsubmit="return checkForm('댕댕이 정보를 등록하시겠습니까?')">
 	 <sec:csrfInput/>
         ...
         <table class="table table-bordered">
             <tbody>   
               	<tr>
                    ...
                    <td><input type="text" name="name" class="form-control" id="exampleInputText" required="required"></td>
                  </tr>
                  <tr>
   ...
   <div class="row" style="margin-top: 30px;">
      ...
      <div class="col-sm-4">
	         <button type="submit" class="btn btn-outline-danger" id="dogSubmitBtn" 
	            style="width: 100px; height: 30px; font-size: 12px; margin-top: 8px; margin-bottom: 8px; padding-top: 8px; cursor: pointer">인증</button>
